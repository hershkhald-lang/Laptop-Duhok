(function () {
  ...
  function getLang() {
    return document.documentElement.getAttribute("lang") === "ckb" ? "ckb" : "ar";
  }
  ...
  function categoryLabel(id) {
    ...
    for (var i = 0; i < cats.length; i++) {
      if (cats[i].id === id) {
        ...
        return lang === "ckb" ? cats[i].name_ckb || cats[i].name_ar || id : cats[i].name_ar || id;
      }
    }
    var map = {
      all: { ar: "الكل", ckb: "هەموو" },
      cashier: { ar: "أجهزة الكاشير", ckb: "ئامێرەکانی کاشێر" },
      laptops: { ar: "اللابتوبات", ckb: "لاپتۆپەکان" },
      paper: { ar: "الورق والمستلزمات", ckb: "کاغەز و پێداویستی" },
      peripherals: { ar: "كيبورد وماوس", ckb: "تەختە و ماوس" },
      accessories: { ar: "إكسسوارات", ckb: "ئەکسسوار" },
    };
    var lang = getLang();
