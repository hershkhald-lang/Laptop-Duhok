...
-- نفّذ بعد schema.sql و admin-users.sql (جدول المسؤولين)
...
drop policy if exists "site_cms_admin_all" on public.site_cms;
create policy "site_cms_admin_all"
  on public.site_cms for all to authenticated
