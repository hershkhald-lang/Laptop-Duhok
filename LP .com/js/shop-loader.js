  ...
  window.LD_SHOP_READY = (async function () {
    ...
    try {
      ...
      window.LD_SHOP_CATEGORIES = [
        { id: "all", icon: "grid", name_ar: "الكل", name_ckb: "هەموو", name_bad: "هەمی" },
      ].concat(
        cats.map(function (c) {
          return {
            id: c.slug,
            ...
            name_ar: c.name_ar || "",
            name_ckb: c.name_ckb || "",
            name_bad: c.name_bad || c.name_ckb || "",
          };
        })
      );
